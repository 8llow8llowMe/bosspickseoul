...
@Builder
public record CommercialSalesCountByTimeSlotInfo(
    ...
    public static CommercialSalesCountByTimeSlotInfo from(SalesCommercial salesCommercial) {
        return CommercialSalesCountByTimeSlotInfo.builder()
