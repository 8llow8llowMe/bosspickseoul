...
public class CommercialServiceSwaggerConfig {

    @Bean
    public OpenAPI commercialServiceOpenApi(Components components) {
        return new OpenAPI()
            .components(components)
            .info(new Info()
                .title("BossPickSeoul 상권 분석 서비스 관련 API 명세서")
                .description("Commercial Service 전용")
                .version("v1")
            )
