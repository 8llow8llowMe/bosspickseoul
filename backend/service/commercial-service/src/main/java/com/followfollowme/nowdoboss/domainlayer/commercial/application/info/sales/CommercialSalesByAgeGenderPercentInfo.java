...
@Builder
public record CommercialSalesByAgeGenderPercentInfo(
    ...
    public static CommercialSalesByAgeGenderPercentInfo from(SalesCommercial salesCommercial) {
        long total = salesCommercial.maleSalesAmount() + salesCommercial.femaleSalesAmount();

        return CommercialSalesByAgeGenderPercentInfo.builder()
            .maleAge10Percent(
