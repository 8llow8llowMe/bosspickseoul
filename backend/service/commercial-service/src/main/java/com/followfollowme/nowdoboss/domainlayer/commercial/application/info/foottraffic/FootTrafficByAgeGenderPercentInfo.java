...
@Builder
public record FootTrafficByAgeGenderPercentInfo(
    ...
    public static FootTrafficByAgeGenderPercentInfo from(FootTrafficCommercial footTrafficCommercial) {
        long total = footTrafficCommercial.totalFootTraffic();

        return FootTrafficByAgeGenderPercentInfo.builder()
            .maleAge10Percent(
