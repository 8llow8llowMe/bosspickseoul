...
@Builder
public record CommercialResidentPopulationByAgeInfo(
    ...
    public static CommercialResidentPopulationByAgeInfo from(PopulationCommercial populationCommercial) {
        return CommercialResidentPopulationByAgeInfo.builder()
