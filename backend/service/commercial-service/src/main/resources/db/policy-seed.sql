...
-- 기업마당 수집 Job 이 켜지면 BIZINFO 로 재매핑한 두 건은 upsert 로 갱신되고,
-- 나머지 SEED 행은 stale-mark / purge 대상이 아니다.
--
...
--   source / external_id    upsert 키. 기업마당 공고 두 건은 BIZINFO + pblancId
...
(9000000000000000001, '소상공인 정책자금 (일반경영안정자금)', '소상공인시장진흥공단', 'FUNDING',
 ...
 'SEED', 'seed-9000000000000000001', '2026-09-09 00:00:00'),
(9000000000000000002, '서울시 긴급자영업자금', '서울신용보증재단', 'FUNDING',
 ...
 'SEED', 'seed-9000000000000000002', '2026-09-09 00:00:00'),
(9000000000000000003, '2026년 스마트상점 기술보급사업 (2차)', '소상공인시장진흥공단', 'FACILITY',
 ...
 'SEED', 'seed-9000000000000000003', '2026-09-09 00:00:00'),
(9000000000000000004, '서울시 소상공인 아카데미', '서울특별시 자영업지원센터', 'EDUCATION',
 ...
 'SEED', 'seed-9000000000000000004', '2026-09-09 00:00:00'),
(9000000000000000005, '자영업자 안심통장 4호', '서울신용보증재단', 'FUNDING',
 ...
 'SEED', 'seed-9000000000000000005', '2026-09-09 00:00:00'),

-- 업종 대분류 한정 (음식 CS1). 검증된 CS2·CS3 전용 공고가 없어 허구 직무교육·무인결제는 넣지 않는다.
-- 서비스·소매 상권은 전 지역 정책(카테고리 NULL)으로 매칭된다.
-- 기업마당 공고: 첫 수집 upsert 가 이 행을 갱신하도록 BIZINFO + pblancId 로 둔다.
(9000000000000000011, '2026년 식품안심업소 기술지원', '한국식품안전관리인증원', 'SUBSIDY',
 ...
 'BIZINFO', 'PBLN_000000000120010', '2026-09-09 00:00:00'),
(9000000000000000012, '서울배달상생자금', '서울신용보증재단', 'FUNDING',
 ...
 'SEED', 'seed-9000000000000000012', '2026-09-09 00:00:00'),
(9000000000000000013, '서울형 다시서기 프로젝트', '서울시', 'SUBSIDY',
 ...
 'SEED', 'seed-9000000000000000013', '2026-09-09 00:00:00'),
(9000000000000000014, '서울시 식품진흥기금 시설개선 융자', '서울시', 'FACILITY',
 ...
 'SEED', 'seed-9000000000000000014', '2026-09-09 00:00:00'),
...
(9000000000000000022, '2026년 라이브커머스 제작·운영 지원사업', '한국중소벤처기업유통원', 'MARKETING',
 ...
 'BIZINFO', 'PBLN_000000000124551', '2026-09-09 00:00:00'),
...
(9000000000000000021, '강남구 중소기업·소상공인 대출이자 지원', '강남구청', 'SUBSIDY',
 ...
 'SEED', 'seed-9000000000000000021', '2026-09-09 00:00:00'),
(9000000000000000023, '송파구 특별신용보증', '송파구청', 'FUNDING',
 ...
 'SEED', 'seed-9000000000000000023', '2026-09-09 00:00:00'),
(9000000000000000024, '종로구 소상공인 라이브커머스 지원사업', '종로구청', 'MARKETING',
 ...
 'SEED', 'seed-9000000000000000024', '2026-09-09 00:00:00'),
(9000000000000000025, '영등포구 소기업·소상공인 특별신용보증', '영등포구청', 'FUNDING',
 ...
 'SEED', 'seed-9000000000000000025', '2026-09-09 00:00:00');
