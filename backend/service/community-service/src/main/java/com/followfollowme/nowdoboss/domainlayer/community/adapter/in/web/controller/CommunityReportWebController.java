...
@Tag(name = "커뮤니티 신고", description = "커뮤니티 게시글 및 댓글 신고 API")
public class CommunityReportWebController {
    ...
    public ResponseEntity<Response<Void>> createReport(@AuthenticationPrincipal MemberLoginActive loginActive,
