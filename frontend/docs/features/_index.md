...
| ---------- | ---------------------------------------- | ---------------------------------------- | --------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| home       | [home](./home/home.md)                   | `(shell)/`                               | ✅ 이관·검증 완료                                   | 인터랙티브 랜딩 리디자인(상권 분석 미니데모·스크롤 등장) 구현 완료. 히어로는 "떠 있는 분석 창 + 살아있는 지도"(방향 C) 인터랙티브 wow로 갱신 완료 — [plan](../superpowers/plans/2026-08-10-home-hero-interactive-wow.md) · [spec](../superpowers/specs/2026-08-10-home-hero-interactive-design.md). Top 10·지도는 status 소유 |
...
| analysis   | [analysis](./analysis/analysis.md)       | `(shell)/analysis,result,simulation…`    | 🟩 명세 완료·구현(AI 리포트 SSE 개편 반영)          | 지도 탐색 + 라우트 모달/독립 결과 페이지. AI 리포트는 3종(자치구/행정동/상권) POST 제출→SSE 구독(폴백 3초 폴링) + 미인증 잠금 카드로 구현 완료. 세부: [ai-report](./analysis/ai-report.md)                                                                                                                                    |
