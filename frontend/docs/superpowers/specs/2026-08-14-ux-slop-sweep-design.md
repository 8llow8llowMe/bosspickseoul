...
- 상태: **PR1 완료(`#152`)** · **PR2 완료(`#154`, 재검증 결과 대폭 축소 — §8)** · **PR3 완료(`#156` — §9)** · PR4·PR-Home 미착수
- **PR4 는 다른 컴퓨터에서 이어받는다 → [2026-08-27-ux-slop-sweep-pr4-handoff.md](./2026-08-27-ux-slop-sweep-pr4-handoff.md)** (자족 핸드오프: 대상 위치·정본 근거·환경 함정·PR3 미완 검증)
